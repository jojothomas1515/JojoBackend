...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    username = models.CharField(_('username'), unique=True, max_length=200, null=True, blank=True)
    ...
    date_joined = models.DateTimeField(default=timezone.now,max_length=200)
